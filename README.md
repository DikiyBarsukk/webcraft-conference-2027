...
Static GitHub Pages version of the WebCraft Conference 2027 registration form.
It is deployed automatically from `main`. Form delivery is configured with the
`FORM_ENDPOINT` GitHub Actions secret.
